...
import static com.dmedia.dlimited.HomeTabActivity.PREFERENCE_COACH_MARK_PRODUCT;
...
public class ProductInformationActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void showCoachMark() {
        ...
        masterView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.putString(PREFERENCE_COACH_MARK_PRODUCT, "checked");
                editor.commit();
            }
        });
        dialog.show();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        SharedPreferences prefs = getSharedPreferences(PREFERENCE_COACH_MARK, MODE_PRIVATE);
        String check = prefs.getString(PREFERENCE_COACH_MARK_PRODUCT, "");
        if (check.equals("")) {
            showCoachMark();
        }
