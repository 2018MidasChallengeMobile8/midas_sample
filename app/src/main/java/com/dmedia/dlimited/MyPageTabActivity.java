...
import com.dmedia.dlimited.widgets.GrayScaleImageView;
import com.dmedia.dlimited.widgets.RoundedImageView;
...
import static com.dmedia.dlimited.HomeTabActivity.PREFERENCE_COACH_MARK_MY_PAGE;
...
public class MyPageTabActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void showCoachMark() {
        ...
        masterView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.putString(PREFERENCE_COACH_MARK_MY_PAGE, "checked");
                editor.commit();
            }
        });
        dialog.show();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        SharedPreferences prefs = getSharedPreferences(PREFERENCE_COACH_MARK, MODE_PRIVATE);
        String check = prefs.getString(PREFERENCE_COACH_MARK_MY_PAGE, "");
        if (check.equals("")) {
            showCoachMark();
        }
