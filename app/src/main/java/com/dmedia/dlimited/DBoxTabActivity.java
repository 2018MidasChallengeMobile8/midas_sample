...
import static com.dmedia.dlimited.HomeTabActivity.PREFERENCE_COACH_MARK_DBOX;
...
public class DBoxTabActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void showCoachMark() {
        ...
        masterView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.putString(PREFERENCE_COACH_MARK_DBOX, "checked");
                editor.commit();
            }
        });
        dialog.show();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        SharedPreferences prefs = getSharedPreferences(PREFERENCE_COACH_MARK, MODE_PRIVATE);
        String check = prefs.getString(PREFERENCE_COACH_MARK_DBOX, "");
        if (check.equals("")) {
            showCoachMark();
        }
