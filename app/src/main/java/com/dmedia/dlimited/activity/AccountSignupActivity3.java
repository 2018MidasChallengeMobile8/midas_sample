...
public class AccountSignupActivity3 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        AccountSignupAgreementActivity.mSignupAgreementActivity.finish();
        AccountSignupActivity1.mSignupActivty1.finish();
        AccountSignupActivity2.mSignupActivty2.finish();
        ...
        String prefPhone = prefs.getString(AccountLoginActivity.PREFERENCE_LOGIN_ID, "");
