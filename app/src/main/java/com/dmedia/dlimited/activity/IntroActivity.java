...
import static com.dmedia.dlimited.activity.AccountLoginActivity.PREFERENCE_LOGIN_UDID;
...
public class IntroActivity extends AppCompatActivity {
    ...
    private void initialization() {
        ...
        if (FirebaseInstanceId.getInstance().getToken() != null) {
            ...
            SharedPreferences prefsNoti = getSharedPreferences(SettingsNotificationActivity.PREFERENCE_SETTING, MODE_PRIVATE);
            String eventCheck = prefsNoti.getString(SettingsNotificationActivity.PREFERENCE_SETTING_EVENT_ALARM, "true");
            String inviteCheck = prefsNoti.getString(SettingsNotificationActivity.PREFERENCE_SETTING_INVITE_ALARM, "true");
