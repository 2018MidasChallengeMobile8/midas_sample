...
import com.dmedia.dlimited.fragment.EventInformationTabGroupFragment;
import com.dmedia.dlimited.fragment.EventInformationTabInformationFragment;
...
public class EventInformationActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void showCoachMark() {
        ...
        masterView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.putString(HomeTabActivity.PREFERENCE_COACH_MARK_EVENT, "checked");
                editor.commit();
            }
        });
        dialog.show();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        SharedPreferences prefs = getSharedPreferences(HomeTabActivity.PREFERENCE_COACH_MARK, MODE_PRIVATE);
        String check = prefs.getString(HomeTabActivity.PREFERENCE_COACH_MARK_EVENT, "");
        if (check.equals("")) {
            showCoachMark();
        }
        //SharedPreferences.Editor editor = prefs.edit();
