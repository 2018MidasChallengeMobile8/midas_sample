...
public class NetManager extends AsyncTask<Void, Void, JSONObject> {
    ...
    java.lang.RuntimeException: An error occurred while executing doInBackground()
     ...
     Caused by: java.lang.RuntimeException: Can't create handler inside thread that has not called Looper.prepare()
        ...
        at com.dmedia.dlimited.NetManager$override.checkResponse(NetManager.java:269)
        at com.dmedia.dlimited.NetManager$override.doInBackground(NetManager.java:135)
        at com.dmedia.dlimited.NetManager$override.access$dispatch(NetManager.java)
        at com.dmedia.dlimited.NetManager.doInBackground(NetManager.java:0)
        at com.dmedia.dlimited.NetManager.doInBackground(NetManager.java:34)
...
//        super.onPreExecute();
        if (mNetData.getProgressType() == NetData.ProgressType.NONE) {
            ...
            LoadingProgress.showProgress(mContext, "데이터 전송 중입니다.");
        } else if (mNetData.getProgressType() == NetData.ProgressType.SPLASH) {
            LoadingProgress.showProgress(mContext);
        }
    }
