...
import com.dmedia.dlimited.dialog.InstagramDialog;
...
public class InstagramApp {
    ...
    public InstagramApp(Context context, String clientId, String clientSecret,
        ...
        mAuthUrl = AUTH_URL + "?client_id=" + clientId + "&redirect_uri="
                + mCallbackUrl + "&response_type=code&scope=basic+public_content";
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == WHAT_ERROR) {
                mProgress.dismiss();
                if (msg.arg1 == 1) {
                    mListener.onFail("토큰을 얻는데 실패하였습니다.");
                } else if (msg.arg1 == 2) {
                    mListener.onFail("유저 정보를 가져오지 못했습니다.");
                }
    ...
    public void setAccessToken(String token) {
        mSession.storeAccessToken(token);
    }
